                ...
                <li>
                  <img src="img/slider/2.jpg" alt="img">
                   <div class="slider_caption">
                    <h2>Welcome to Computational Media Lab</h2>
                    <p>Computational Media Lab, at KAIST. <p>
      ...
      <div class="container">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
          <div class="aboutus_area wow fadeInLeft">
            <h2 class="titile">About CML</h2>
            <p>The Computational Media Lab at KAIST is 
                  ...
                  <li>
                    <div class="media">
                      ...
                      <div class="media-body">
                       ...
                       <a href="#">Mars 2017</a>
                       <span class="feed_date">2 papers accepted at CVPR</span>
                      </div>
                    </div>                    
                  </li>
                  <li>
    ...
    <section id="ourTutors">
      <div class="container">
         <div class="row">
          <div class="col-lg-12 col-md-12"> 
            <div class="title_area">
              <h2 class="title_two">Students</h2>
              <span></span> 
            </div>
          </div>
        </div>
